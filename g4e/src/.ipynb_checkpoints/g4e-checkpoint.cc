...
int main(int argc, char **argv)
{
    ...
    G4long seed = time(NULL);  // add random seed 1/12
    CLHEP::HepRandom::setTheSeed(seed); // add random seed 1/12
    ...
    runManager->SetUserInitialization(physicslist_high); 
    ...
    // Execute all macros
    std::string filename = "cone_pgun_my.mac";
