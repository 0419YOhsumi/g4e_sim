...
// define here Global volume parameters
  //double Width=2400.*mm;
  double Thickness=3000.*mm;
  double Zpos;
  double Xpos;
  double Angle=-0.0265;
...
public:
    ...
    //    ffi_ZDC_det_Material = G4Material::GetMaterial("Iron");
        //Solid = new G4Box("ffi_ZDC_GVol_Solid", cfg.Width*0.5 , cfg.Width *0.5, cfg.Thickness );
        Solid = new G4Box("ffi_ZDC_GVol_Solid", cfg.Width*0.5 + gap, cfg.Width*0.5 + gap, cfg.Thickness );
      ...
      inline void ConstructTowels() {
          ...
          ffi_ZDC_HCAL_ROut = 120 * cm;
          ffi_ZDC_HCAL_Width = 100. * mm;
          ffi_ZDC_HCAL_Gap = 0.01 * mm;
          ffi_ZDC_HCAL_Thickness = 50.*mm;
          //ffi_ZDC_HCAL_Width = 32. * cm;
          //ffi_ZDC_HCAL_Gap = 0.01 * mm;

          ffi_ZDC_HCAL_Material = fMat->GetMaterial("Tungsten_m");
          ffi_ZDC_HCAL_Solid = new G4Box("ffi_ZDC_HCAL_Solid", ffi_ZDC_HCAL_Width*0.5 ,
                                            ffi_ZDC_HCAL_Width*0.5 , ffi_ZDC_HCAL_Thickness );
          ...
          double max_c = 275*mm;
          //double gap_c = 100*mm;
          //double max_c_z = 725*mm;
          
          double gap_z_c = 100*mm;
          double gap_c = 50*mm;
          double max_c_z = 725*mm;
          
          for(int l=0; l<30; l++){
              
              z_c = -max_c_z + ( l*gap_z_c );
              
              abname_z = Form("_z%d", l);
              //sprintf(abname_z, "_%d", l);
              ...
              for(int j=0; j<12; j++){
                  ...
                  for(int i=0; i<12; i++){
                      ...
                      abname = Form("ffi_ZDC_HCAL_Phys_%d", k);
                      //sprintf(abname, "ffi_ZDC_HCAL_Phys_%d", k);
                      
                      string cell_name = abname + abname_z;
                      
                      new G4PVPlacement(0, G4ThreeVector(x_c, y_c, z_c), cell_name, 
                                        ffi_ZDC_HCAL_Logic,
                                        Phys, false, k);
...
//============  For sectors =====
    ...
    G4Box *ffi_ZDC_HCAL_bloc_Solid;
    G4LogicalVolume *ffi_ZDC_HCAL_bloc_Logic;
...
g4e::Materials *fMat;
    ...
    G4VisAttributes *attr_ffi_ZDC_HCAL_bloc;
